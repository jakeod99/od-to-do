...
YearlyRecurringTaskTemplate.create!([
  ...
  {
    status: "active",
    title: "Spread Fertilizer Over Lawn",
    description: "Spread 64 pounds (4x 16lb bags) of 'Fertilome Centipede Lawn Fertilizer 15-0-5'. Usually best scheduled for Saturday, ideally after a bag mow",
    days: [ "6/14" ],
    is_firm: false,
    complexity: :medium,
    urgency: :medium,
